...
- Read [Hermes Agent Architecture]({{< ref "hermes-agent-architecture.md" >}})
  to understand the moving parts.
- Read [Skills, Memory, and Context in
  Hermes]({{< ref "hermes-skills-memory-context.md" >}}) before storing
  knowledge in the wrong layer.
- Read [Hermes as a GitOps SRE
  Assistant]({{< ref "hermes-gitops-sre-assistant.md" >}}) for the operational
