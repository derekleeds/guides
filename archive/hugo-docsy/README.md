...
Remove this archive only after:

1. the Astro site is deployed to `guides.derekleeds.cloud`;
2. representative old URLs, search, metadata, and assets pass production checks;
3. the two-week Search Console observation window shows no migration regression;
4. a rollback decision and content backup are recorded.

Archived from the pre-migration `main` branch state on 2026-08-19.
